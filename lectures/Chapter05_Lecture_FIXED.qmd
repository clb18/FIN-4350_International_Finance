...
-   **“The FX market is a physical place.”**  
    It’s overwhelmingly an electronic, global, OTC network.
...
**Teaching anchor:** NDFs are an institutional workaround—“we’ll settle the P&L in dollars rather than deliver the restricted currency.”
...
Classroom point: London’s role as a global hub reflects time zone overlap, institutional depth, and historical network effects.

### Currency composition

![Daily FX Trading by Currency Pair](../assets/images/Ch05/Exhibit_5.8_currency_composition.png){width="90%"}
...
-   **“Spot means instantaneous.”**  
    In interbank markets it typically settles T+2.
...
1.  A U.S. firm will pay JPY in 3 months. What FX instrument most directly locks in the USD cost today?
2.  Why might a bank use swaps repeatedly rather than a single long-dated forward?
...
![Bid, Ask, and Mid-Point Quotation](../assets/images/Ch05/Exhibit_5.10_bid_ask_midpoint.png){width="80%"}

A useful operational rule:

-   *You buy at the ask; you sell at the bid.*

![Exchange Rates: New York Closing Snapshot](../assets/images/Ch05/Exhibit_5.11_WSJ_closing_snapshot.png){width="90%"}
...
**Important teaching note:** the sign and interpretation can flip depending on quote convention (American vs European terms). The safest approach is: define your quote clearly, compute \((F-S)/S\), and interpret the meaning in words (“more or fewer USD per 1 unit of foreign currency”).
...
1.  If EUR/USD is 1.10, what is USD/EUR?  
2.  If a dealer quotes EUR/USD 1.1000–1.1004, what price do you pay to buy euros?
3.  If the implied EUR/GBP differs from the quoted EUR/GBP, what additional information do you need before declaring “free money”?
